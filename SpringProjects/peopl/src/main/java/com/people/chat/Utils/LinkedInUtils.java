...
public class LinkedInUtils {
    ...
    private static final String CLIENT_SECRET = "IuVL9w67ZyGhv3xy";
    private static final String REDIRECT_URI = "https://www.linkedin.com/developer/apps";
    private static final String CLIENT_ID = "86i1bzb08lo1n9";
    ...
    private static String getProfilePhotoUrl(String accessToken) throws Exception {
